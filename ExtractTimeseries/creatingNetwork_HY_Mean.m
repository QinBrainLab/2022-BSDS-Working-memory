function creatingNetwork_HY_Mean(Config_File)
% This is the configuration template file for copy data from a group of participants 
addpath(genpath('/brain/iCAN/home/Heying/SPM'));
...
for FCi = 1:numsubj
   ...
   for roicnt = 1:numroi                              
    ...
    %edit by wuliyun
	save(strcat(outputdir,'subtimeseris_',num2str(FCi)), 'all_roi_ts', 'roi_names');
