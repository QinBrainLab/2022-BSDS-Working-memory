% computeLowerBound.m : This script calculates the lower bound on the log evidence
...
for t = 1:s
 ...
 Fmatrix(2,t) = eps;%+sum( Qns(:,t).*( -log(Qnsmod(:,t)) +ones(n,1)*(tempdig_u(t)-tempdig_usum) ) );
