...
%Note Gammas - Gammas for one state.
...
% Updates the mean and covariance of q(a) (note a - Vec(A))
...
%Updates Scale and Shape parameters of the Inverse Wishart Distribution
